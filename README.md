...
<li>If SIG.Integral[1th,12th] != 0 , BKG.Integral[1th,12th] != 0 ==> Just like the ratio bin content formula, signal/background=the value it has[13th ratio bin content=the value it has]</li> 
</ol>
...
<li>If SIG.Integral[17th,25th] != 0 , BKG.Integral[17th,25th] != 0 ==> Just like the ratio bin content formula, signal/background=the value it has[16th ratio bin content=the value it has]</li> 
</ol>
